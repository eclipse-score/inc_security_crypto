...
.. list-table:: General Checklist
      ...
      * - Gen 1
        - Are the safety analysis performed according to the defined process and templates? See :need:`gd_req__saf_structure` and also :need:`doc__crypto_fmea` and :need:`doc__crypto_dfa`
        - [YES | NO ]

...
#ifndef SCORE_CRYPTO_SRC_API_CONFIG_HASH_CONTEXT_CONFIG_HPP
#define SCORE_CRYPTO_SRC_API_CONFIG_HASH_CONTEXT_CONFIG_HPP
...
#endif  // SCORE_CRYPTO_SRC_API_CONFIG_HASH_CONTEXT_CONFIG_HPP

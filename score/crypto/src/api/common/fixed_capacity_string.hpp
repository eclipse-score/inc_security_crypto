...
#ifndef SCORE_CRYPTO_SRC_API_COMMON_FIXED_CAPACITY_STRING_HPP
#define SCORE_CRYPTO_SRC_API_COMMON_FIXED_CAPACITY_STRING_HPP
...
#endif  // SCORE_CRYPTO_SRC_API_COMMON_FIXED_CAPACITY_STRING_HPP

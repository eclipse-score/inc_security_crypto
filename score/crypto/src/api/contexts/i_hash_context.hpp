...
#ifndef SCORE_CRYPTO_API_CONTEXTS_I_HASH_CONTEXT_HPP
#define SCORE_CRYPTO_API_CONTEXTS_I_HASH_CONTEXT_HPP
...
#endif  // SCORE_CRYPTO_API_CONTEXTS_I_HASH_CONTEXT_HPP

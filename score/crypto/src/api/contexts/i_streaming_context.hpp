...
#ifndef SCORE_CRYPTO_SRC_API_CONTEXTS_I_STREAMING_CONTEXT_HPP
#define SCORE_CRYPTO_SRC_API_CONTEXTS_I_STREAMING_CONTEXT_HPP
...
#endif  // SCORE_CRYPTO_SRC_API_CONTEXTS_I_STREAMING_CONTEXT_HPP

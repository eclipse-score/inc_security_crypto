...
#ifndef SCORE_CRYPTO_SRC_API_FUTURE_CONTEXTS_I_AEAD_CONTEXT_HPP
#define SCORE_CRYPTO_SRC_API_FUTURE_CONTEXTS_I_AEAD_CONTEXT_HPP
...
#endif  // SCORE_CRYPTO_SRC_API_FUTURE_CONTEXTS_I_AEAD_CONTEXT_HPP

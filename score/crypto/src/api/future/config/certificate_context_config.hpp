...
#ifndef SCORE_CRYPTO_API_FUTURE_CONFIG_CERTIFICATE_CONTEXT_CONFIG_HPP
#define SCORE_CRYPTO_API_FUTURE_CONFIG_CERTIFICATE_CONTEXT_CONFIG_HPP
...
#endif  // SCORE_CRYPTO_API_FUTURE_CONFIG_CERTIFICATE_CONTEXT_CONFIG_HPP

...
#ifndef SCORE_CRYPTO_SRC_API_FUTURE_CONFIG_CSR_GENERATION_CONTEXT_CONFIG_HPP
#define SCORE_CRYPTO_SRC_API_FUTURE_CONFIG_CSR_GENERATION_CONTEXT_CONFIG_HPP

...
pub type CK_NOTIFY = Option<
    unsafe extern "C" fn(hSession: CK_SESSION_HANDLE, event: CK_NOTIFICATION, pApplication: *mut c_void) -> CK_RV,
>;
...
pub struct CK_FUNCTION_LIST {
    ...
    pub C_InitToken:
        Option<unsafe extern "C" fn(CK_SLOT_ID, *const CK_UTF8CHAR, CK_ULONG, *const CK_UTF8CHAR) -> CK_RV>,
    pub C_InitPIN: Option<unsafe extern "C" fn(CK_SESSION_HANDLE, *const CK_UTF8CHAR, CK_ULONG) -> CK_RV>,
    pub C_SetPIN: Option<
        unsafe extern "C" fn(CK_SESSION_HANDLE, *const CK_UTF8CHAR, CK_ULONG, *const CK_UTF8CHAR, CK_ULONG) -> CK_RV,
    >,
    pub C_OpenSession:
        Option<unsafe extern "C" fn(CK_SLOT_ID, CK_FLAGS, *mut c_void, CK_NOTIFY, *mut CK_SESSION_HANDLE) -> CK_RV>,
    ...
    pub C_SetOperationState: Option<
        unsafe extern "C" fn(CK_SESSION_HANDLE, *const CK_BYTE, CK_ULONG, CK_OBJECT_HANDLE, CK_OBJECT_HANDLE) -> CK_RV,
    >,
    ...
    pub C_CreateObject:
        Option<unsafe extern "C" fn(CK_SESSION_HANDLE, *const CK_ATTRIBUTE, CK_ULONG, *mut CK_OBJECT_HANDLE) -> CK_RV>,
    ...
    pub C_GetAttributeValue:
        Option<unsafe extern "C" fn(CK_SESSION_HANDLE, CK_OBJECT_HANDLE, *mut CK_ATTRIBUTE, CK_ULONG) -> CK_RV>,
    ...
    pub C_FindObjects:
        Option<unsafe extern "C" fn(CK_SESSION_HANDLE, *mut CK_OBJECT_HANDLE, CK_ULONG, *mut CK_ULONG) -> CK_RV>,
    ...
    pub C_Encrypt:
        Option<unsafe extern "C" fn(CK_SESSION_HANDLE, *const CK_BYTE, CK_ULONG, *mut CK_BYTE, *mut CK_ULONG) -> CK_RV>,
    pub C_EncryptUpdate:
        Option<unsafe extern "C" fn(CK_SESSION_HANDLE, *const CK_BYTE, CK_ULONG, *mut CK_BYTE, *mut CK_ULONG) -> CK_RV>,
    ...
    pub C_SignRecoverInit:
        Option<unsafe extern "C" fn(CK_SESSION_HANDLE, *const CK_MECHANISM, CK_OBJECT_HANDLE) -> CK_RV>,
    pub C_SignRecover:
        Option<unsafe extern "C" fn(CK_SESSION_HANDLE, *const CK_BYTE, CK_ULONG, *mut CK_BYTE, *mut CK_ULONG) -> CK_RV>,
    pub C_VerifyInit: Option<unsafe extern "C" fn(CK_SESSION_HANDLE, *const CK_MECHANISM, CK_OBJECT_HANDLE) -> CK_RV>,
    pub C_Verify:
        Option<unsafe extern "C" fn(CK_SESSION_HANDLE, *const CK_BYTE, CK_ULONG, *const CK_BYTE, CK_ULONG) -> CK_RV>,
...
pub struct CK_FUNCTION_LIST_3_0 {
    ...
    pub C_GetInterface:
        Option<unsafe extern "C" fn(*const CK_UTF8CHAR, *mut CK_VERSION, *mut *const CK_INTERFACE, CK_FLAGS) -> CK_RV>,
    ...
    >,
    pub C_EncryptMessageBegin:
        Option<unsafe extern "C" fn(CK_SESSION_HANDLE, *const c_void, CK_ULONG, *const CK_BYTE, CK_ULONG) -> CK_RV>,

...
fn aes_gcm_message_roundtrip() {
    ...
    unsafe {
        ...
        assert_eq!(
            ct_len as usize,
            plaintext.len(),
            "ciphertext length must equal plaintext length (tag is separate)"
        );
...
fn per_message_different_ivs() {
    ...
    unsafe {
        ...
        let rv = p11!(
            ...
            C_EncryptMessage,
            h,
            &params1 as *const _ as *const c_void,
            std::mem::size_of::<CK_GCM_MESSAGE_PARAMS>() as CK_ULONG,
            ptr::null(),
            0,
            plaintext.as_ptr(),
        ...
        let rv = p11!(
            ...
            C_EncryptMessage,
            h,
            &params2 as *const _ as *const c_void,
            std::mem::size_of::<CK_GCM_MESSAGE_PARAMS>() as CK_ULONG,
            ptr::null(),
            0,
            plaintext.as_ptr(),
